  ...
  return (
    <section id="services" className="py-24 bg-[#FAF8F5] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Services Grid with Stagger Pop-Up */}
        <ScrollStaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, index) => (
            <ScrollStaggerItem key={service.id} className={index === 0 ? 'md:col-span-2 lg:col-span-1' : ''}>
              <div className="group bg-[#FAF8F5] rounded-3xl overflow-hidden border border-[#E8D5C8]/80 shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col h-full">
                {/* Image Header */}
