    ...
    <section id="about" className="py-20 bg-[#F3EFE9] border-y border-[#E8D5C8]/60 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-6">
          ...
          <ScrollPop delay={0.1} scaleStart={0.85}>
          ...
          <ScrollPop delay={0.2} scaleStart={0.9}>
          ...
          <ScrollStaggerContainer className="pt-6 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
            <ScrollStaggerItem>
              <div className="bg-[#FAF8F5] p-5 rounded-2xl border border-[#E8D5C8]/80 shadow-xs h-full">
