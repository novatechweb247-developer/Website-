        ...
        <ScrollStaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {WHY_CHOOSE_US.map((item, idx) => (
            <ScrollStaggerItem key={idx}>
              <div className="bg-[#FAF8F5] p-8 rounded-3xl border border-[#E8D5C8]/80 shadow-xs hover:border-[#A67C52]/50 transition-all duration-300 flex flex-col justify-between h-full">
                <div>
