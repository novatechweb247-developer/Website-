    ...
    <section id="contact" className="py-24 bg-[#FAF8F5] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          {/* Address Details Box */}
          <div className="lg:col-span-5 bg-[#F3EFE9] p-8 sm:p-10 rounded-3xl border border-[#E8D5C8] shadow-xs flex flex-col justify-between space-y-8">
          ...
          <div className="lg:col-span-7 bg-[#F3EFE9] rounded-3xl overflow-hidden border border-[#E8D5C8] relative shadow-xs min-h-[340px] flex flex-col justify-between p-6 sm:p-8">
